...
int main()
{
    ...
    // Buat Kicauan
    AddressKicauan kicau1, kicau2;

    // ID
    ID(InfoKicauan(kicau1)) = 1;
    // Like
    LIKE(InfoKicauan(kicau1)) = 77;
    // Author
    AUTHOR(InfoKicauan(kicau1)) = &joseph;
    // Datetime
    DATETIME(InfoKicauan(kicau1)) = time1;
    // Text
    strcpy(TEXT(InfoKicauan(kicau1)), "AKU JOSEPH");

    // ID
    ID(InfoKicauan(kicau2)) = 2;
    // Like
    LIKE(InfoKicauan(kicau2)) = 70;
    // Author
    AUTHOR(InfoKicauan(kicau2)) = &ucup;
    // Datetime
    DATETIME(InfoKicauan(kicau2)) = time1;
    // Text
    strcpy(TEXT(InfoKicauan(kicau2)), "AKU YUDUF");
