/* File : prioqueueint.h */
/* Definisi ADT Priority Queue int dengan representasi array secara eksplisit dan alokasi dinamik */
/* Model Implementasi Versi III dengan circular buffer */
/* Elemen queue terurut membesar berdasarkan elemen prio */

#ifndef prioqueueint_H
#define prioqueueint_H
...
/* Contoh deklarasi variabel bertype PrioQueueint : */
...
/* Definisi PrioQueueint kosong: HEAD=Nil; TAIL=Nil. */
/* Catatan implementasi: T[0] tidak pernah dipakai */

/* ********* AKSES (Selektor) ********* */
/* Jika e adalah infotypeQ dan Q adalah PrioQueueint, maka akses elemen : */
...
/* *** Primitif Add/Delete *** */
void Enqueue (PrioQueueint * Q, infotypeQ X);
...
void Dequeue (PrioQueueint * Q, infotypeQ * X);
